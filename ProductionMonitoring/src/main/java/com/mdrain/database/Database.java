...
public class Database {
	...
	private Database() {
		...
		try {
			this.connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/aps_staff", "root", "");
			System.out.println("Connection success");
		} catch (SQLException e) {
			e.printStackTrace();
			System.out.println(DataBaseConfig.getUrl() + DataBaseConfig.getCredentials());
		}
	}
	...
	public void insertUsers(String fullName, String userName, String email, String password) {
		...
		String dataColumn = clambStart + quote + fullName + quote + comma 
	...
	public void insertProductionInfo(String m_date, String productionOrder, String operator, int productionTime,
			int quantity, boolean isNewOperator) {

		String dataColumn = clambStart + quote + m_date + quote + comma 
		...
		try {
			...
			queryManager.execute(
					"INSERT INTO production_info (m_date, production_order, operator, production_time, quantity, new_operator) VAUES "
							+ dataColumn);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void insertOperatorsInfo(String fullName, String teamLeader, String gender, String skills, String isActive,
		...
		try {
			queryManager = this.connection.createStatement();
			queryManager.execute(
					"INSERT INTO operators (operator_name, team_leader, gender, skills, isActive, isMotherhood, phone) VALUES "
							+ dataColumn);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
